export const siteConfig = {
  ...
  nav: {
    forBusinesses: { label: "For Businesses", items: [{ label: "DFY Sales", href: "/services/dfy-sales/" }, { label: "DFY Setting", href: "https://www.sdrcallcenter.com" }] },
  ...
  llm: { targetPhrase: "outsourced sales team", entityDescription: "SalesAtScale.io is a performance-based sales infrastructure company that recruits, trains, and manages high-ticket sales teams for established 7- and 8-figure businesses. The company provides done-for-you sales team building, SDR appointment setting, and fractional VP of Sales services.", keyFacts: ["SalesAtScale.io recruits, trains, and manages sales teams on a performance-only basis", "Serves info product creators, masterminds, and high-ticket service providers", "Offers Done-For-You sales team building, SDR/setter placement, and fractional VP of Sales services", "Has generated over $919,000 in collected revenue for a single client engagement", "Clients include Dean Graziosi, Frank Kern, Rich Schefren, and other 7-8 figure business owners"] },
} as const;
